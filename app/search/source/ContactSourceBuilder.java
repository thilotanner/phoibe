...
public class ContactSourceBuilder implements SourceBuilder<Contact> {
    ...
    public XContentBuilder buildSource(Contact contact) throws IOException {
        ...
        builder.startObject()
                ...
                .field(SourceBuilder.SORTABLE_INDEX_PREFIX + "company", contact.company)
                .field("title", contact.title)
                .field("firstName", contact.firstName)
                .field(SourceBuilder.SORTABLE_INDEX_PREFIX + "firstName", contact.firstName)
                .field("lastName", contact.lastName)
                .field(SourceBuilder.SORTABLE_INDEX_PREFIX + "lastName", contact.lastName)
                .field("street", contact.street)
                .field(SourceBuilder.SORTABLE_INDEX_PREFIX + "street", contact.street)
                .field("postOfficeBox", contact.postOfficeBox)
                .field("postalCode", contact.postalCode)
                .field("city", contact.city)
                .field(SourceBuilder.SORTABLE_INDEX_PREFIX + "city", contact.city)
    ...
    public XContentBuilder buildMapping() throws IOException {
        ...
        builder.startObject()
                ...
                .startObject(SourceBuilder.SORTABLE_INDEX_PREFIX + "company")
                .field("type", "string")
                .field("index", "not_analyzed")
                .endObject()
                ...
                .startObject(SourceBuilder.SORTABLE_INDEX_PREFIX + "firstName")
                .field("type", "string")
                .field("index", "not_analyzed")
                .endObject()
                ...
                .startObject(SourceBuilder.SORTABLE_INDEX_PREFIX + "lastName")
                .field("type", "string")
                .field("index", "not_analyzed")
                .endObject()
                ...
                .startObject(SourceBuilder.SORTABLE_INDEX_PREFIX + "street")
                .field("type", "string")
                .field("index", "not_analyzed")
                .endObject()
                ...
                .startObject(SourceBuilder.SORTABLE_INDEX_PREFIX + "city")
                .field("type", "string")
                .field("index", "not_analyzed")
                .endObject()
